...
st.set_page_config(page_title= "Airbnb Data Visualization | By SudheerBv",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *SudheerBv*!
...
client = pymongo.MongoClient("mongodb+srv://sudheer:j1dsiFhk6hklRlV1@cluster0.parsrd3.mongodb.net/?retryWrites=true&w=majority")
...
if selected == "Overview":
    ...
    with tab2:
        ...
        with col2:
            ...
            country_df = df.query(query).groupby(['Country'],as_index=False)['Name'].count().rename(columns={'Name' : 'Total_Listings'}) # type: ignore
...
if selected == "Explore":
    ...
    with col1:
        ...
        pr_df = df.query(query).groupby('Room_type',as_index=False)['Price'].mean().sort_values(by='Price') # type: ignore
