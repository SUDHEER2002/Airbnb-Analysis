...
data = pd.read_csv(r'C:\\Users\\DELL\\OneDrive - Amrita vishwa vidyapeetham\\Desktop\\New folder (3)\\airbnb_dataset.csv')
...
with tab1:
    ...
    if country_in and city_in and min_price and max_price:
        try:
            ...
            base_map = folium.Map(location=[base_latitude,base_longitude], zoom_start=12) # type: ignore
